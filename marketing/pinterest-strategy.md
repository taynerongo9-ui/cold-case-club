# Cold Case Club — Pinterest Strategy

> **Why Pinterest:** Pinterest users have purchase intent. 85% of weekly Pinners have made a purchase from Pinterest. Gift searches peak 6-8 weeks before holidays. True crime + mystery + gift = our exact niche.
...
### 1. "Mystery Subscription Gifts"
Gift-focused pins. Mother's Day, birthdays, Christmas, Valentine's.

### 2. "True Crime Gift Guide"
Broader content — not just CCC. Pins linking to our gift guide blog post.

### 3. "Cold Case Club — Inside the Investigation"
Product pins showing evidence packets, the experience, unboxing.

### 4. "Murder Mystery Night Ideas"
Pins linking to our how-to blog post. Decor, food, setup ideas.

### 5. "Detective Aesthetic"
Mood board — noir photography, magnifying glasses, old newspapers, mystery novels. Builds brand association.
...
- **Keywords in title and first 50 characters** of description (Pinterest SEO is keyword-driven)
- **2:3 aspect ratio** images (1000x1500px) for maximum visibility
- **Text overlay** on images — Pinterest is visual-first, text helps stop the scroll
- **Schedule pins** for 8-11 PM and weekends (peak Pinterest usage)
- **5-10 pins per day** to new + existing boards
- **Rich pins enabled** via website claim
- **Alt text** on all pin images with keywords

## Key Keywords to Target

- mystery subscription box
- true crime gift
- gift for mystery lovers
- mother's day gift unique
